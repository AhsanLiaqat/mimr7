...
app.use('/settings/player-lists', require('./routes/settings/class_list.js'));
app.use('/content-plan-templates', require('./routes/content-plan-template.js'));
app.use('/question-scheduling', require('./routes/scheduled_questions.js'));
...
app.use('/article-libraries', require('./routes/collection-library.js'));
app.use('/messages', require('./routes/highlights.js'));
app.use('/responses', require('./routes/responses.js'));
app.use('/questions', require('./routes/message.js'));
