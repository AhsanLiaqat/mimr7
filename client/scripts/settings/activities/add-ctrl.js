(function () {
    ...
    angular.module('app')
    .controller('addActivityModalCtrl', ['$scope', '$rootScope', 'close', 'incident', 'task', '$routeParams', '$http', 'AuthService',    'ModalService',    '$location',    '$timeout',    '$filter',  'Query','DepartmentService','ActivityService','IncidentTeamService' ,'OrganizationService','RoleService','TaskService',   ctrlFunction]);

    function ctrlFunction($scope, $rootScope, close, incident, task, $routeParams, $http, AuthService, ModalService, $location, $timeout, $filter, Query,DepartmentService,ActivityService, IncidentTeamService, OrganizationService, RoleService, TaskService) {
        ...
        function init() {
            ...
            if(task != null){
                $scope.activity.taskListId = task.id;
            }
