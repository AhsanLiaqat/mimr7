(function () {
    ...
    angular.module('app')
    .controller('userInfoModalCtrl', ['$scope',
    '$rootScope',
    'close',
    '$routeParams',
    '$http',
        ...
        $scope.actorSelection = function () {
            ...
            $scope.save = function () {
                if ($scope.activity.response_actor && $scope.selectedActor === $scope.activity.response_actor.id){
                    ...
                    IncidentActivityService.updateActor($scope.activity.id,{responseActorId: $scope.activity.response_actor.id}).then(function(result){
                    ...
                    // $http.put('/incident-activities/update-actor/' + $scope.activity.id,
