(function () {
    ...
    angular.module('app')
        .controller('reportViewModalCtrl', ['$scope','$rootScope', '$routeParams', '$http', 'AuthService', 'ModalService', '$location','report','$sce','ReportService', viewFunction]);

        function viewFunction($scope, $rootScope,$routeParams, $http, AuthService, ModalService, $location,report,$sce, ReportService) {
